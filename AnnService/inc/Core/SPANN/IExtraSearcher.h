...
#include "inc/Core/Common/PostingVersionLabel.h"
...
namespace SPTAG {
    namespace SPANN {
        ...
        public:
            ...
            virtual void SavePostingSizesAndVersionMap() { return; }

            virtual void ShowPostingDistribution(int num, bool needPrint){return;}
