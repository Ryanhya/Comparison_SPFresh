...
//new def
DefineSSDParameter(m_baseVectorSplitPath, std::string, std::string(""), "BaseVectorSplitPath")
DefineSSDParameter(m_startNum, int, 0, "StartNum")
DefineSSDParameter(m_ternimateNum, int, 0, "TernimateNum")
DefineSSDParameter(m_searchWaitMilliTime, int, 0, "SearchWaitMilliTime")
DefineSSDParameter(m_streamingUpdate, bool, true, "StreamingUpdate")
DefineSSDParameter(m_smallestTimeUnit, int, 0, "SmallestTimeUnit")
