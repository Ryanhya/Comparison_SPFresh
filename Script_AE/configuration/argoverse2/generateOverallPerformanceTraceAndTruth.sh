setname="6c VectorPath=/home/lyh/datasets/embeddings/test/batches/base_embeddings"
truthname="18c TruthPath=/home/lyh/datasets/embeddings/test/batches/base_embeddings_truth"
...
{  
    ...
    sed -i "$newsetname" /home/lyh/baselines/SPFresh_baseline/Script_AE/configuration/argoverse2/genTruth.ini  #修改genTruth.ini 文件中第六行的VectorPath值
    sed -i "$newtruthname" /home/lyh/baselines/SPFresh_baseline/Script_AE/configuration/argoverse2/genTruth.ini  #修改genTruth.ini 文件中第十八行的TruthPath值
    sed -i "$newquerysize" /home/lyh/baselines/SPFresh_baseline/Script_AE/configuration/argoverse2/genTruth.ini  #修改genTruth.ini 文件中第十二行的TruthPath值

    /home/lyh/baselines/SPFresh_baseline/Debug/usefultool -BuildVector true --vectortype float --BaseVectorPath /home/lyh/datasets/embeddings/test/base_embeddings.bin --CurrentListFileName /home/lyh/datasets/embeddings/test/batches/base_embedding_ids --QueryVectorPath /home/lyh/datasets/embeddings/test/query_embeddings.bin --BaseVectorSplitPath /home/lyh/datasets/embeddings/test/query_vector_range.bin --filetype DEFAULT --ride $ride -d 256 -f DEFAULT --Batch $i -NewDataSetFileName /home/lyh/datasets/embeddings/test/batches/base_embeddings -NewQueryDataSetFileName /home/lyh/datasets/embeddings/test/batches/query_embeddings
    
    
    
    #/home/lyh/SPFresh/Release/ssdserving /home/lyh/SPFresh/Script_AE/configuration/argoverse2/genTruth.ini 
